...
let apiKey = "515c74fb86mshcb44e437cf75abcp1b8dc7jsn1ac8f5643c83";
let buttonS = $(".summitBnt");



let dailyCaloryEl = $(".dailyCalories");
let bmiEl = $(".bmi");
let idealWeightEl = $(".idealWeight");
let bodyFatEl = $(".bodyFat");
...
$.ajax(settings).done(function (response) {
    console.log(response);
    $(".resultados").text(response.data.BMR)
});
...
$.ajax(settings).done(function (response) {
    console.log(response);
    $(".resultados").text(response.Devine)
